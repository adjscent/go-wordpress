# go-wordpress
[![GoDoc](https://godoc.org/github.com/adjscent/go-wordpress?status.svg)](https://godoc.org/github.com/adjscent/go-wordpress)
...
```bash
go get github.com/adjscent/go-wordpress
```
...
import (
  ...
  "github.com/adjscent/go-wordpress"
)
...
cd $GOPATH/src/github.com/adjscent/go-wordpress
go test
```
